...
(function() {
  jQuery(function() {
    return $(document).ready(function() {
      $('.reporting-prompt').on('click', '.edit-reporting-prompt', function(e) {
        $(e).preventDefault;
        return $.ajax({
      ...
      return $('.reporting-prompt').on('click', '.cancel-editing-reporting-prompt', function() {
        $('.reporting-prompt-url-form').hide();
        $('.reporting-prompt-text').show();
        return $('.reporting-prompt').addClass('emphasise');
      });
    });
  });
...
function setSegmentTrack(map, segment, index) {
  ...
  if (alertLevel == "0") {
    icon = '/assets/icons/grn-circle-lv-4845230512c02e3d904c33b98102c1c6dcf46755775cc30fe0e31b0c5e287413.png';
    lineColour = "#00FF77";
  } else if (alertLevel == "1") {
    icon = '/assets/icons/2-lv-3d020b99860eea3a9f8d6de6ba6aa2ff1cd28010c960c817163b35b814dae67c.png';
    lineColour = "#FF8800";
  } else if (alertLevel == "2") {
    icon = '/assets/icons/3-lv-612022461c66865c9b2ed5e44718e2b3a358fce9ba800824f7e855c6850f920a.png';
    lineColour = "#FF6600";
  } else if (alertLevel == "3") {
    icon = '/assets/icons/4-lv-5915b6f767d2ac9d8c9c767cc5f77a35600591ccb3c51ca192c407badcfb9c1e.png';
    lineColour = "#FF4400";
  } else if (alertLevel == "4") {
    icon = '/assets/icons/5-lv-4270089677debe4fbe20f9d08b74ec838f5936a3878460244b8f4b179f07c1b8.png';
    lineColour = "#FF2200";
  } else if (alertLevel == "5") {
    icon = '/assets/icons/6-lv-383a49e2a94c8ba4f1791e22c9f8aed96c2a26c6e31e79e8033c78a0505436c0.png';
    lineColour = "#FF0000";
  } else {
    icon = '/assets/icons/purple-circle-lv-0c2dec6e250d91fe51427b2d7051f3afafb119d5da08a43be7ddccab27bfd6d5.png';
    lineColour = "#8800FF";
  }
...
(function() {
  jQuery(function() {
    return $(document).ready(function() {
      $('article.user').on('change', 'input#image_src', function() {
        $('article.user input#image_src').closest('form').submit();
        return $('.profile-image').html('<img class="ajax-loader" alt="loading" src="/images/ajax-loader-fb.gif"><br>uploading');
      });
      $('article.user').on('click', '.reveal-browse-button', function(e) {
        e.preventDefault();
        $(this).hide();
        return $('article.user #image_src').show();
      });
      $('.user-info-link').on('mouseover', function(e) {
        return $.ajax({
          dataType: 'html',
          url: '/users/' + $(this).find('a').data('user-id') + '/user_info',
          error: function(jqXHR, textStatus, errorThrown) {
            return $(this).find('.user-info').html('Error loading user summary');
          },
          success: (function(_this) {
            return function(data, textStatus, jqXHR) {
              return $(_this).find('.user-info').html(data);
            };
          })(this)
        });
      });
      return $('#user_region_id').on('change', function() {
        return $.ajax({
          dataType: 'html',
          url: '/regions/' + $(this).val() + '/group_options',
          error: function(jqXHR, textStatus, errorThrown) {
            return $('#user_group_ids').html('Error loading groups');
          },
          success: (function(_this) {
            return function(data, textStatus, jqXHR) {
              return $('#user_group_ids').html(data);
            };
          })(this)
        });
      });
